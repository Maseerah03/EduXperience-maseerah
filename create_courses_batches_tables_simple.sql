-- Create courses table for institution management (Corrected Version)
...
-- Create batches table for institution management (Corrected Version)
...
-- RLS Policies for courses table (Corrected)
...
-- RLS Policies for batches table (Corrected)
